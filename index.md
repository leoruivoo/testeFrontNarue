...
<!-- Modern or es5 bundle, pickr color -->
<script src="https://cdn.jsdelivr.net/npm/@simonwep/pickr/dist/pickr.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/@simonwep/pickr/dist/pickr.es5.min.js"></script>
<!-- Inputmask jquery -->
<script type='text/javascript' src="https://rawgit.com/RobinHerbots/jquery.inputmask/4.x/dist/jquery.inputmask.bundle.js"></script>

<!-- Personalizado JS -->
<script type='text/javascript' src="js/projeto/personalizado.js"></script>
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
      ...
      customButtons: {
        add_event: {
            icon: 'plus-square',
            click: function(info) {
              // $('#ModalAdd #datahoraComeca').val(info.start.toLocaleString());
              // $('#ModalAdd #datahoraTermina').val(info.end.toLocaleString());
              $("#ModalAdd").modal('show');
            }
        },
        materias: {
            text: 'Matérias',
            click: function() {
              if($(".visMaterias").css("display") == "none"){
                $(".visMaterias").slideToggle();
                if($(".visFalta").css("display") == "block"){
        ...
        <div class="modal-content">
          ...
          <!-- Modal Header -->
            ...
            <div class="modal-body container ">
              ...
              <div class="card col-12 card-margin-top badge-dark text-white p-0 p-sm-3">
                <div class="card-body">
                  <div class="row">
          ...
          <div class="modal-content ModalVisEventAdd">
...
<!-- Bootstrap 4 js -->
<!-- ja tem no moment <script src="https://code.jquery.com/jquery-3.3.1.slim.min.js" integrity="sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo" crossorigin="anonymous"></script> -->
